								...
								return function (visibleEndIndex) {
									return function (viewportHeight) {
										return function (viewportY) {
											return {cursorPosition: cursorPosition, filename: filename, newRecord: newRecord, oldRecords: oldRecords, records: records, sidePanelExpanded: sidePanelExpanded, suggested: suggested, viewportHeight: viewportHeight, viewportY: viewportY, visibleEndIndex: visibleEndIndex, visibleStartIndex: visibleStartIndex};
										};
									};
								};
							};
...
var author$project$Otter$WinViewportInfo = function (a) {
	return {$: 'WinViewportInfo', a: a};
};
...
var author$project$Otter$checkTableViewport = A2(
	...
	author$project$Otter$handleError(author$project$Otter$WinViewportInfo),
...
var author$project$Otter$focusCursor = author$project$Ports$focusCursor(_Utils_Tuple0);
...
var author$project$Otter$init = function (_n0) {
	return _Utils_Tuple2(
		author$project$Otter$Model(true)('')(
			...
			A2(author$project$Otter$CursorPosition, 0, elm$core$Maybe$Nothing))(0)(0)(0)(0),
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[author$project$Otter$checkTableViewport, author$project$Otter$focusCursor])));
};
var author$project$Otter$WinResize = {$: 'WinResize'};
...
var author$project$Otter$subscriptions = function (_n0) {
	return elm$browser$Browser$Events$onResize(
		F2(
			function (_n1, _n2) {
				return author$project$Otter$WinResize;
			}));
};
...
var author$project$Otter$NoOp = {$: 'NoOp'};
var author$project$Otter$ScrollUpdate = F2(
	function (a, b) {
		return {$: 'ScrollUpdate', a: a, b: b};
	});
var author$project$Otter$VirUpdate = {$: 'VirUpdate'};
var author$project$Otter$ScrollBarInfo = function (a) {
	return {$: 'ScrollBarInfo', a: a};
};
var author$project$Otter$checkScrollbar = A2(
	elm$core$Task$attempt,
	author$project$Otter$handleError(author$project$Otter$ScrollBarInfo),
		...
		var oldLotNo = A2(
			...
			_Utils_eq(
				_Utils_update(
					record,
					{lotNo: ''}),
				author$project$Records$emptyRecord) ? suggestion : elm$core$Maybe$Just(record.oldLotNo));
		return A3(
			author$project$Prelude$maybe,
			_Utils_update(
				record,
...
var author$project$Otter$getNewRecord = function (model) {
	var newRecord = A3(author$project$Otter$getSuggestion, model.suggested, model.newRecord, model.oldRecords);
	return (model.newRecord.lotNo === '') ? _Utils_update(
		newRecord,
		{
			lotNo: A3(
				author$project$Prelude$maybe,
				...
				author$project$Otter$getFreshLotNo(model.records))
		}) : newRecord;
};
...
var author$project$Otter$maybeClamp = F3(
	function (totalRecords, f, m) {
		var n = A2(elm$core$Maybe$withDefault, totalRecords, m);
		var c = A3(
			elm$core$Basics$clamp,
			0,
			totalRecords,
			f(n));
		return (_Utils_cmp(c, totalRecords) < 0) ? elm$core$Maybe$Just(c) : elm$core$Maybe$Nothing;
	});
var author$project$Otter$tableHeight = function (model) {
	return (elm$core$Array$length(model.records) + 2) * author$project$Otter$row_height;
};
...
var author$project$Otter$virUpdate = A2(
	elm$core$Task$perform,
			...
			switch (msg.$) {
				...
				case 'ToggleSidePanel':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{sidePanelExpanded: !model.sidePanelExpanded}),
						elm$core$Platform$Cmd$none);
				case 'FilenameEdited':
					var newText = msg.a;
					return _Utils_Tuple2(
					...
					if (_Utils_eq(event.keyCode, SwiftsNamesake$proper_keyboard$Keyboard$Key$Enter)) {
						...
						var $temp$msg = author$project$Otter$VirUpdate,
							...
							model,
							{
								...
								newRecord: author$project$Records$emptyRecord,
								records: newNewRecords,
								suggested: A2(author$project$Otter$genSuggestion, model.oldRecords, newNewRecords)
							});
						msg = $temp$msg;
						model = $temp$model;
						continue update;
						...
						if (suggestion) {
							...
							var newNewRecords = A2(
								...
								elm$core$Array$fromList(
									A2(elm$core$List$map, author$project$Records$importListToRecord, csv.records)));
							var $temp$msg = author$project$Otter$VirUpdate,
								$temp$model = _Utils_update(
								model,
								{
				...
				case 'CsvExported':
					return _Utils_Tuple2(
						...
						A3(
							...
							author$project$Otter$csv_mime,
							author$project$Records$recordsToCsv(model.records)));
				case 'ScrollWheel':
					var event = msg.a;
					var $temp$msg = A2(
						author$project$Otter$ScrollUpdate,
						false,
						A2(
							author$project$Prelude$flip,
				...
				case 'ScrollUpdate':
					...
					var newViewportY = A3(
						elm$core$Basics$clamp,
						0,
						author$project$Otter$tableHeight(model) - model.viewportHeight,
						...
						elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									...
									author$project$Otter$virUpdate
								])));
				case 'VirUpdate':
					var numRecords = elm$core$Array$length(model.records);
					var _n2 = A3(author$project$Otter$getVisibleRows, numRecords, model.viewportHeight, model.viewportY);
					var bottom = _n2.a;
					var top = _n2.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{visibleEndIndex: top, visibleStartIndex: bottom}),
						author$project$Otter$focusCursor);
				case 'WinResize':
					return _Utils_Tuple2(model, author$project$Otter$checkTableViewport);
				case 'WinViewportInfo':
					var viewport = msg.a;
					var $temp$msg = author$project$Otter$VirUpdate,
						$temp$model = _Utils_update(
						model,
										...
										_Utils_update(
											cursorPosition,
											{
												x: A2(
													elm$core$Basics$max,
													0,
													author$project$Prelude$pred(cursorPosition.x))
											}));
								case 'Right':
									return A2(
										author$project$Otter$CursorMoved,
										...
										_Utils_update(
											cursorPosition,
											{
												x: A2(
													elm$core$Basics$min,
													4,
													author$project$Prelude$succ(cursorPosition.x))
											}));
								case 'Tab':
									return A2(
										author$project$Otter$CursorMoved,
								...
								case 'Up':
									return A2(
										...
										_Utils_update(
											cursorPosition,
											{
												y: A3(author$project$Otter$maybeClamp, recordNum, author$project$Prelude$pred, cursorPosition.y)
											}));
								case 'Down':
									return A2(
										author$project$Otter$CursorMoved,
										...
										_Utils_update(
											cursorPosition,
											{
												y: A3(author$project$Otter$maybeClamp, recordNum, author$project$Prelude$succ, cursorPosition.y)
											}));
								case 'Enter':
									return A2(
										author$project$Otter$CursorMoved,
				...
				case 'CursorMoved':
					...
					var bottomClamp = (topClamp + (2 * author$project$Otter$row_height)) - model.viewportHeight;
						...
						function () {
							var columnUpdate = A2(
								...
								A2(
									...
									A2(
										...
										model.cursorPosition.x,
										elm$core$Basics$always(newText))),
								author$project$Records$recordToList);
							var rowUpdate = function (cursorY) {
								var newNewRecords = A3(author$project$Prelude$updateAtt, cursorY, columnUpdate, model.records);
							...
							return A3(
								...
								_Utils_update(
									model,
									{
										newRecord: columnUpdate(model.newRecord)
									}),
								rowUpdate,
...
var author$project$Otter$CursorArrow = function (a) {
	return {$: 'CursorArrow', a: a};
};
var author$project$Otter$DontScrollViewport = {$: 'DontScrollViewport'};
var author$project$Otter$FilenameEdited = function (a) {
	return {$: 'FilenameEdited', a: a};
};
var author$project$Otter$PortExample = {$: 'PortExample'};
var author$project$Otter$ScrollBar = {$: 'ScrollBar'};
var author$project$Otter$ScrollWheel = function (a) {
	return {$: 'ScrollWheel', a: a};
};
var author$project$Otter$ToggleSidePanel = {$: 'ToggleSidePanel'};
...
var author$project$Otter$suggestionCell = F3(
...
var author$project$Otter$bottomRow = F4(
	function (suggested, mCursorX, cursorY, record) {
		...
		var mCursorPositions = A3(
			author$project$Prelude$updateAt,
			A2(elm$core$Maybe$withDefault, -1, mCursorX),
		...
		var cells = A2(
			...
			A2(
				...
				A2(
					elm$core$List$cons,
					author$project$Otter$suggestionCell(suggested),
		...
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$id('bottomRow'),
...
var author$project$Otter$recordsToRows = F3(
	function (visibleStartIndex, cursorPosition, records) {
		var cursorRowNum = A2(
			elm$core$Maybe$map,
			A2(author$project$Prelude$flip, elm$core$Basics$sub, visibleStartIndex),
			cursorPosition.y);
		var createRow = F2(
			function (rowNum, record) {
				return A3(
					...
					_Utils_eq(
						cursorRowNum,
						elm$core$Maybe$Just(rowNum)) ? elm$core$Maybe$Just(cursorPosition.x) : elm$core$Maybe$Nothing,
...
var author$project$Otter$renderedRows = function (model) {
	return A3(
		...
		elm$core$Array$toList(
			A3(elm$core$Array$slice, model.visibleStartIndex, model.visibleEndIndex + 1, model.records)));
};
							...
							[
								...
								_List_fromArray(
									[
										...
										author$project$Otter$onKeydown(author$project$Otter$CursorArrow),
										mpizenberg$elm_pointer_events$Html$Events$Extra$Wheel$onWheel(author$project$Otter$ScrollWheel),
									...
									[
										...
										_List_fromArray(
											[
												...
												elm$html$Html$Attributes$class('ui single line fixed unstackable celled compact table'),
												A2(
												elm$html$Html$Attributes$style,
												'top',
												'-' + (elm$core$String$fromInt(model.viewportY) + 'px'))
											]),
										_List_fromArray(
											[
												A2(
												...
												_Utils_ap(
													_List_fromArray(
														[
															(!A2(elm$core$Basics$modBy, 2, model.visibleStartIndex)) ? A2(elm$html$Html$tr, _List_Nil, _List_Nil) : author$project$Otter$html_empty,
															A2(
															elm$html$Html$tr,
															_List_Nil,
															_List_fromArray(
																[
																	...
																	_List_fromArray(
																		[
																			...
																			elm$html$Html$Attributes$style,
																			'height',
																			elm$core$String$fromInt(model.visibleStartIndex * author$project$Otter$row_height) + 'px')
																		]),
																	_List_Nil)
																]))
														]),
																	...
																	[
																		...
																		_List_fromArray(
																			[
																				...
																				'height',
																				elm$core$String$fromInt(
																					((elm$core$Array$length(model.records) - 1) - model.visibleEndIndex) * author$project$Otter$row_height) + 'px')
																			]),
																		_List_Nil)
																	])),
																A4(
																author$project$Otter$bottomRow,
																model.suggested,
																author$project$Prelude$isJust(model.cursorPosition.y) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(model.cursorPosition.x),
																elm$core$Maybe$Nothing,
																model.newRecord)
															]))))
											]))
								...
								_List_fromArray(
									[
										...
										author$project$Otter$onScroll(author$project$Otter$ScrollBar)
									]),
								_List_fromArray(
									[
										A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										(model.sidePanelExpanded && author$project$Otter$debug) ? A2(
										elm$html$Html$div,
										_List_fromArray(
											[
												elm$html$Html$Attributes$class('ui segment')
...
var author$project$Otter$main = elm$browser$Browser$document(
	{init: author$project$Otter$init, subscriptions: author$project$Otter$subscriptions, update: author$project$Otter$update, view: author$project$Otter$view});
